...
# Sanitize origins to remove whitespace and prevent wildcard '*' which is forbidden with allow_credentials=True
allowed_origins = [origin.strip() for origin in allowed_origins_raw if origin.strip() and origin.strip() != "*"]
