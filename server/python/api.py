...
async def ler_tabela(
    ...
    try:
        ...
        # ⚡ Bolt: Use lazy evaluation (scan_parquet) to push down filters and slice before reading to memory, improving I/O performance
        ...
        return {
            ...
            "schema": {col: str(schema[col]) for col in colunas_disponiveis},
        }
    except ImportError:
        raise HTTPException(
            status_code=500,
