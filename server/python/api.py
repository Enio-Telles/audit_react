...
# Sanitize origins to remove whitespace and prevent wildcard usage when credentials are allowed
allowed_origins = [origin.strip() for origin in raw_origins if origin.strip() and origin.strip() != "*"]
