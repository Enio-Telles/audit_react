# Contexto da Tabela: produtos_selecionados

## Objetivos
Esta pasta contém o contrato e gerador exclusivo para a tabela `produtos_selecionados`.
...
4. Use variáveis e métodos em português.
