"""
Servico de pipeline para o backend FastAPI.

Esta implementacao promove a logica antes hospedada em
`src/interface_grafica/services/pipeline_funcoes_service.py` para uma camada
de servico canônica do backend.
"""
