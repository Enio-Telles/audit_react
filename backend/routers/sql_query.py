...
def create_sql_file(req: SqlFileCreate):
    ...
    if req.folder.strip():
        ...
        # 🛡️ Sentinel: Fix potential path traversal bypass. String matching like .startswith() can be bypassed (e.g. /app/sql_fake matching /app/sql). Using path.is_relative_to() instead.
