...
def get_bloco_h_resumo(
    ...
    # ⚡ Bolt Optimization: Compute multiple metrics concurrently in a single DataFrame scan using to_dicts()[0]
    agg_exprs = []
    ...
    if total_linhas > 0:
        ...
        inventarios_h005 = aggs.get("inventarios_h005", 0)
        total_produtos = aggs.get("total_produtos", 0)
        valor_total_itens = float(aggs.get("valor_total_itens") or 0.0)
    else:
        inventarios_h005 = 0
        total_produtos = 0
        valor_total_itens = 0.0
