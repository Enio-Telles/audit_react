...
export interface DossieComparisonSummary {
  ...
  ultimaEstrategiaReferencia?: string | null;
  ultimaSqlPrincipalReferencia?: string | null;
  ultimoStatusComparacao?: string | null;
  ultimoCacheKey?: string | null;
  ultimoTotalChavesFaltantes?: number | null;
  ultimoTotalChavesExtras?: number | null;
  ultimaAmostraChavesFaltantes?: string[] | null;
  ultimaAmostraChavesExtras?: string[] | null;
  ultimosCamposCriticosAtual?: Record<string, number> | null;
  ultimosCamposCriticosReferencia?: Record<string, number> | null;
  updatedAt?: string | null;
  historyFile: string;
}
