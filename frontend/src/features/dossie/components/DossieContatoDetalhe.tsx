...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Cache status calculations and consolidate 5 array iterations (.reduce, .filter) into a single O(N) pass to improve rendering performance for large contacts lists.
