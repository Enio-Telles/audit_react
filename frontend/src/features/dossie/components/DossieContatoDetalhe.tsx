...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Consolidated 5 separate iterations (.reduce, .filter) into a single for...of loop.
    // This caches the expensive 'calcular_status_entidade' evaluation per entity and prevents redundant O(N) array passes.
