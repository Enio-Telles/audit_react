...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Consolidate multiple reduce/filter passes into a single loop. This reduces redundant O(N) traversals and caches the expensive 'calcular_status_entidade' evaluation.
