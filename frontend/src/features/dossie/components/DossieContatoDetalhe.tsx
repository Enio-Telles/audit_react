...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Consolidated multiple array traversals into a single pass and cached the expensive calcular_status_entidade result to avoid redundant evaluations, improving rendering performance.
