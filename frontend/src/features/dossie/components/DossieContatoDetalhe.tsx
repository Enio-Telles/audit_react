...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt Optimization: Replace chained array.reduce() and array.filter() with a single for...of loop.
    // This prevents redundant O(N) traversals per metric and avoids multiple array allocations on large datasets.
