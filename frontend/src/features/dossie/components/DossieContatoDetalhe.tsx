...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Consolidate multiple array iterations and cache expensive status calculations
    // into a single pass to improve performance, avoiding redundant O(N) evaluations.
