...
function resumir_grupos(
  ...
  return (Object.keys(grupos) as GrupoAgenda[]).map((grupo) => {
    ...
    // ⚡ Bolt: Consolidated 5 O(N) array iterations into a single for...of loop and cached the result of the expensive calcular_status_entidade function. This prevents redundant dataset traversals and double-evaluation of complex rules per entity.
