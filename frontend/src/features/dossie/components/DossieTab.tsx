        ...
        <button
          ...
          className={`ml-0.5 rounded p-0.5 text-[11px] transition-colors ${
            isSyncing
              ...
              : "text-slate-500 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 hover:text-blue-300"
          }`}
        >
