                  ...
                  >
                    ...
                    <td className="px-2 py-1.5 border-b border-slate-800 text-center">
                      <button
                        ...
                        className="text-red-400 hover:text-red-300 text-xs leading-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-400 rounded px-1"
                        title="Remover da seleção"
                        aria-label={`Remover ${key} da seleção`}
                      >
                        ✕
                      </button>
                    </td>
