            ...
            <div className="border-t border-slate-700 p-1.5">
              <div className="flex gap-1 mb-1.5 flex-wrap">
                ...
                <button
                  ...
                  aria-expanded={showGerenciarModal}
                >
                  ⚙ Gerenciar
                </button>
              </div>
          ...
          {cnpjs.map((r) => (
            <div key={r.cnpj} className="flex items-center gap-0.5 group">
              ...
              <button
                ...
                className="shrink-0 px-1.5 py-1.5 rounded text-slate-500 hover:text-slate-200 hover:bg-slate-700 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity text-[11px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
              >
                ⚙
              </button>
            </div>
