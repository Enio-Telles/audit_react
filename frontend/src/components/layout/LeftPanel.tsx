          ...
          {cnpjs.map((r) => (
            <div key={r.cnpj} className="flex items-center gap-0.5 group">
              ...
              <button
                ...
                className="shrink-0 px-1.5 py-1.5 rounded text-slate-500 hover:text-slate-200 hover:bg-slate-700 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:outline-none transition-opacity text-[11px]"
              >
                ⚙
              </button>
            </div>
