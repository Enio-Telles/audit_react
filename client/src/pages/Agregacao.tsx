...
export default function Agregacao() {
  ...
  // ⚡ Bolt: Memoize filtered products to prevent re-calculations on checkbox clicks or tab switches
  const filteredProdutos = useMemo(
    () =>
      PRODUTOS_EXEMPLO.filter(
        p =>
  ...
  // ⚡ Bolt: Memoize Set creation and mapping to prevent re-calculations
