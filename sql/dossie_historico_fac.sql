SELECT
    ...
    TRIM(NVL(sit_pessoa.it_nu_ddd, '') || NVL(sit_pessoa.it_nu_telefone, '')) telefone,
    ...
    CONVERT(sit_pessoa.it_tx_logradouro_corresp, 'AL32UTF8', 'WE8MSWIN1252') logradouro_corr,
    CONVERT(sit_pessoa.it_no_bairro_corresp, 'AL32UTF8', 'WE8MSWIN1252') bairro_corr,
    CONVERT(localid_corresp.no_municipio, 'AL32UTF8', 'WE8MSWIN1252') municipio_corr,
    sit_pessoa.it_sg_uf uf_corr,
    TRIM(NVL(sit_pessoa.it_nu_ddd_corresp, '') || NVL(sit_pessoa.it_nu_telefone_corresp, '')) telefone_corr,
...
LEFT JOIN bi.dm_localidade localid_corresp ON sit_pessoa.it_co_municipio_corresp = localid_corresp.co_municipio
