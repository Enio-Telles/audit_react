...
| **saidas_desacob** | Omissao de Saida | `max(0, estoque_final - saldo_final)`. |
| **estoque_final_desacob** | Estoque Ajustado | `max(0, saldo_final - estoque_final)`, com valor minimo zero. |
