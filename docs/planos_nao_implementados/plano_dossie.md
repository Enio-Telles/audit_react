...
- [ ] Mostrar 4 a 6 cards principais no topo
- [ ] Permitir clique no card para abrir o detalhe filtrado
...
- [ ] Comparação por origem/fonte
- [ ] Destaque automático das diferenças
...
- [ ] A. Reorganizar blocos
- [ ] C. Cards-resumo
- [ ] E. Badges e padrão visual
- [ ] F. Tabelas mais limpas

### Fase 2 — Resolver leitura prática de contatos

- [ ] D. Contatos agregados por papel
- [ ] B. Modos Executivo e Auditoria
