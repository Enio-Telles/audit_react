...
Cabeçalho de documentos fiscais da EFD.
"""
...
def _base_path() -> str:
    return os.path.join(os.getcwd(), "data", "raw", "efd", "c100")


def load_c100(ano: Optional[int] = None, mes: Optional[int] = None) -> pl.DataFrame:
    base = _base_path()
