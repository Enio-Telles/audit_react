...
Resumo analítico dos documentos na EFD.
"""
...
def _base_path() -> str:
    return os.path.join(os.getcwd(), "data", "raw", "efd", "c190")


def load_c190(ano: Optional[int] = None, mes: Optional[int] = None) -> pl.DataFrame:
    base = _base_path()
