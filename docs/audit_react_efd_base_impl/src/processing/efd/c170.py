...
Itens dos documentos fiscais da EFD.
"""
...
def _base_path() -> str:
    return os.path.join(os.getcwd(), "data", "raw", "efd", "c170")


def load_c170(ano: Optional[int] = None, mes: Optional[int] = None) -> pl.DataFrame:
    base = _base_path()
