"""
Loader para REG_0220.

Fatores de conversão da EFD.
"""
...
def _base_path() -> str:
    return os.path.join(os.getcwd(), "data", "raw", "efd", "reg_0220")


def load_reg_0220(ano: Optional[int] = None, mes: Optional[int] = None) -> pl.DataFrame:
    base = _base_path()
