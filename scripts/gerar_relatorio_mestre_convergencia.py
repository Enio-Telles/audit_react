...
def montar_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Gera relatorio mestre markdown cruzando comparacao antes/depois com os relatorios da secao contato."
    )
    parser.add_argument(
        "--comparacao-json",
        required=True,
    ...
    parser.add_argument(
        "--saida",
        default=r"c:\Sistema_react\output\verificacao_convergencia\relatorio_mestre_convergencia.md",
        help="Arquivo markdown de saida do relatorio mestre.",
    )
    return parser
...
def main() -> int:
    ...
    conteudo = gerar_relatorio_mestre_convergencia(
